...
@overload
def tuplify(value: Optional[Union[str, Tuple[str, ...]]]) -> Tuple[str, ...]: ...
@overload
def tuplify(value: Optional[Union[int, Tuple[int, ...]]]) -> Tuple[int, ...]: ...
@overload
def tuplify(value: Optional[Union[float, Tuple[float, ...]]]) -> Tuple[float, ...]: ...
@overload
